...
/// Signature aligned with web_image_loader.dart so the package compiles on
/// non-web platforms (Android). No-op; success callback only fires on web
/// (guarded by kIsWeb in custom_network_image.dart).
void setHtmlImageSuccessCallback(String viewType, Function(String, int, int) callback) {
  // Not available on non-web platforms
}
